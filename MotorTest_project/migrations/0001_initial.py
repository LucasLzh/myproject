    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setLimit', models.BooleanField(blank=True, default=False, verbose_name='设置行程')),
                ('percentControl', models.BooleanField(blank=True, default=False, verbose_name='百分比控制')),
                ('angleControl', models.BooleanField(blank=True, default=False, verbose_name='角度控制')),
                ('upControl', models.BooleanField(blank=True, default=False, verbose_name='上行功能')),
                ('downControl', models.BooleanField(blank=True, default=False, verbose_name='下行功能')),
                ('upJogControl', models.BooleanField(blank=True, default=False, verbose_name='上点动功能')),
                ('downJogControl', models.BooleanField(blank=True, default=False, verbose_name='下点动功能')),
                ('setThirdLimit', models.BooleanField(blank=True, default=False, verbose_name='设置第三行程')),
                ('delThirdLimit', models.BooleanField(blank=True, default=False, verbose_name='删除第三行程')),
                ('delLimit', models.BooleanField(blank=True, default=False, verbose_name='删除行程')),
                ('isChangeState', models.BooleanField(blank=True, default=False, verbose_name='状态实时变化功能')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thirdLimitPosition', models.CharField(blank=True, max_length=256, verbose_name='第三行程点位置')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downloadAddress', models.FileField(default=True, upload_to='SoftwareFile', verbose_name='上位机下载地址')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testLog', models.FileField(default=True, upload_to='MotorTest/%Y/%m/%d', verbose_name='电机测试记录log')),
                ('FunctionResult', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='MotorTest_project.Function', verbose_name='电机功能测试表')),
                ('motorMemory', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='MotorTest_project.Memory', verbose_name='电机内存表')),
            ],
            options={
                'verbose_name': '测试结果',
